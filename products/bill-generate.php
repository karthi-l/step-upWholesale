...
<head>
    ...
    <style>
        ...
        .details-table-2 {
            width: 30%; /* Ensure it's consistent with the space it occupies */
            border-collapse: collapse;
            margin-top: 10px;
            table-layout: fixed;
        }
...
<body>
    <div class="invoice-container">
        <div class="header">
            <img src="http://localhost/step-upWholesale-git/step-upWholesale/img/st-logo.png" style="border-radius:.33rem;"alt="Shop Logo">
        ...
        <div class="totalsSection">
            <table class="details-table-2" align="right">
                <tr>
